...
public class Closet4 : MonoBehaviour
{
    ...
    void Update()
    {
        if (CollisionHappening==true&&Input.GetKeyDown(KeyCode.E) && GameObject.Find("Closet4").GetComponent<SpriteRenderer>().sprite == OpenedCloset)
        {
        ...
        else if (CollisionHappening == true && Input.GetKeyDown(KeyCode.E) && GameObject.Find("Closet4").GetComponent<SpriteRenderer>().sprite == ClosedCloset)
        {
